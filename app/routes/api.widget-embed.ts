...
(function() {
  ...
  // ========== CSS (inlined) ==========
  var css = ".gleame-embed-widget{--solid-button-color:#1f2937;--background-color:transparent;--text-color:#1f2937;--description-color:#6b7280;--button-text-color:#fff;--border-color:#e5e7eb;--widget-margin-top:20px;--widget-margin-bottom:20px;--widget-padding:0;--widget-border-radius:16px;--widget-shadow:none;--widget-border:none;--title-font-size:20px;--description-font-size:16px;--button-border-radius:12px;--button-text-case:none;--image-border:none;--image-border-radius:12px;--header-font-family:inherit;--header-font-weight:700;--body-font-family:inherit;--body-font-weight:400;background:var(--background-color);border-radius:var(--widget-border-radius);padding:var(--widget-padding);margin-top:var(--widget-margin-top);margin-bottom:var(--widget-margin-bottom);box-shadow:var(--widget-shadow);border:var(--widget-border);max-width:480px;width:100%;font-family:var(--body-font-family);font-weight:var(--body-font-weight);box-sizing:border-box}.gleame-embed-widget *,.gleame-embed-widget *::before,.gleame-embed-widget *::after{box-sizing:border-box}.gleame-embed-widget .ge-header{margin-bottom:20px}.gleame-embed-widget .ge-title{color:var(--text-color);font-size:var(--title-font-size);font-family:var(--header-font-family);font-weight:var(--header-font-weight);margin:0 0 8px 0;line-height:1.2;letter-spacing:-0.02em}.gleame-embed-widget .ge-desc{color:var(--description-color);font-size:var(--description-font-size);font-family:var(--body-font-family);font-weight:var(--body-font-weight);margin:0;line-height:1.5}.gleame-embed-widget .ge-placeholder{margin-bottom:20px;cursor:pointer;border-radius:8px;overflow:hidden;transition:transform .2s ease,opacity .2s ease}.gleame-embed-widget .ge-placeholder:hover{transform:scale(1.01);opacity:.95}.gleame-embed-widget .ge-placeholder.drag-over{opacity:.7;transform:scale(1.02);outline:2px dashed #8b5cf6;outline-offset:4px}.gleame-embed-widget .ge-default-ph{display:flex;gap:8px;height:200px}.gleame-embed-widget .ge-ph-side{flex:1;border-radius:var(--image-border-radius);overflow:hidden;display:flex;align-items:center;justify-content:center;position:relative}.gleame-embed-widget .ge-ph-before{background:linear-gradient(145deg,#f3f4f6,#e5e7eb)}.gleame-embed-widget .ge-ph-after{background:linear-gradient(145deg,#fef3c7,#fde68a)}.gleame-embed-widget .ge-sil{width:80px;height:100px;background:linear-gradient(180deg,rgba(107,114,128,.5),rgba(75,85,99,.5));border-radius:40px 40px 20px 20px;position:relative;margin-top:25px}.gleame-embed-widget .ge-sil::before{content:'';position:absolute;top:-30px;left:50%;transform:translateX(-50%);width:55px;height:55px;background:linear-gradient(180deg,rgba(107,114,128,.5),rgba(75,85,99,.5));border-radius:50%}.gleame-embed-widget .ge-sil-glow{background:linear-gradient(180deg,rgba(217,119,6,.5),rgba(180,83,9,.5))}.gleame-embed-widget .ge-sil-glow::before{background:linear-gradient(180deg,rgba(217,119,6,.5),rgba(180,83,9,.5))}.gleame-embed-widget .ge-btn{width:100%;padding:16px 24px;border-radius:var(--button-border-radius);font-family:var(--body-font-family);font-size:16px;font-weight:500;cursor:pointer;transition:all .2s ease;display:flex;align-items:center;justify-content:center;gap:10px;text-decoration:none;box-sizing:border-box;background:var(--solid-button-color)!important;color:var(--button-text-color)!important;border:none!important;box-shadow:0 2px 8px rgba(0,0,0,.15)}.gleame-embed-widget .ge-btn:hover{transform:translateY(-1px);box-shadow:0 4px 12px rgba(0,0,0,.2);filter:brightness(1.1)}.gleame-embed-widget .ge-btn:focus{outline:2px solid #8b5cf6;outline-offset:2px}.gleame-embed-widget .ge-btn:focus:not(:focus-visible){outline:none}.gleame-embed-widget .ge-btn .ge-btn-text{text-transform:var(--button-text-case)}.gleame-embed-widget .ge-processing{padding:40px 20px}.gleame-embed-widget .ge-loading{display:flex;flex-direction:column;align-items:center;justify-content:center}.gleame-embed-widget .ge-loading-text{display:flex;align-items:center;justify-content:center;gap:10px;color:var(--text-color);font-size:15px;margin:0}.gleame-embed-widget .ge-spinner{width:18px;height:18px;border:2px solid var(--text-color);border-top-color:transparent;border-radius:50%;animation:ge-spin .8s linear infinite;flex-shrink:0}@keyframes ge-spin{to{transform:rotate(360deg)}}.gleame-embed-widget .ge-results{margin-bottom:20px}.gleame-embed-widget .ge-comparison{display:flex;gap:8px}.gleame-embed-widget .ge-comp-side{flex:1;border-radius:8px;overflow:hidden}.gleame-embed-widget .ge-comp-img{width:100%;height:220px;object-fit:cover;display:block;border-radius:var(--image-border-radius);border:var(--image-border);box-sizing:border-box;image-orientation:from-image}.gleame-embed-widget .ge-error{text-align:center;padding:20px;background:#fef2f2;border-radius:12px;margin-bottom:16px}.gleame-embed-widget .ge-error-icon{color:#dc2626;margin-bottom:12px}.gleame-embed-widget .ge-error-msg{color:#dc2626;font-size:14px;margin:0 0 16px;line-height:1.4}.gleame-embed-widget .ge-footer{display:flex;align-items:flex-start;gap:8px;margin-top:10px;padding-top:5px}.gleame-embed-widget .ge-footer .ge-info-icon{color:#9ca3af;flex-shrink:0;margin-top:2px}.gleame-embed-widget .ge-disclaimer{color:#9ca3af;font-size:12px;margin:0;line-height:1.4}.gleame-embed-widget .ge-powered{text-align:right;font-size:10px;color:rgba(107,114,128,.5);margin-top:2px;padding-right:4px}.gleame-embed-widget .ge-powered strong{font-weight:600;background:linear-gradient(135deg,#8b5cf6,#7c3aed);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text}.gleame-embed-widget .ge-state{transition:opacity .3s ease}@media(max-width:480px){.gleame-embed-widget{max-width:100%}.gleame-embed-widget .ge-title{font-size:calc(var(--title-font-size)*.9)}.gleame-embed-widget .ge-default-ph{height:160px}.gleame-embed-widget .ge-sil{width:60px;height:80px;margin-top:20px}.gleame-embed-widget .ge-sil::before{width:40px;height:40px;top:-24px}.gleame-embed-widget .ge-btn{padding:14px 20px;font-size:15px}.gleame-embed-widget .ge-comp-img{height:180px}}";
  ...
  if (!shopDomain) {
    ...
    if (!shopDomain) {
      ...
      for (var i = 0; i < scripts.length; i++) {
        var m = scripts[i].src.match(new RegExp('//([^/]+\\.myshopify\\.com)'));
