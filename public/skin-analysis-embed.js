...
(function () {
  ...
  var CSS = ''
    ...
    + '.gleame-skin-drop{border:2px dashed #cbd5e1;border-radius:12px;padding:36px 16px;text-align:center;cursor:pointer;transition:border-color .15s,background-color .15s;background:#f8fafc;}'
    ...
    + '.gleame-skin-drop input{display:none;}'
